...
async function run(){
  try {
    // get action inputs
    const url = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('webhook-url', { required: true });
    const method = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('webhook-method');
    ...
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.info(`Webhook triggered successfully (status code: ${response.status})`);
  } catch (error) {
